...
Built and maintained alongside the **[Society Against Mass Entropy](https://github.com/Society-Against-Mass-Entropy/same)** corp. If you want to fly with the fleet, join in-game with invite code `61cd832`.
