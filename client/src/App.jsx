...
export default function App() {
  ...
  const [rightTab, setRightTab] = useState('mission'); // 'mission' | 'autopilot' | 'intel' | 'ai'
        ...
        <section className="col-span-12 lg:col-span-5 flex flex-col">
          <div className="flex items-center gap-1 mb-2 text-xs">
            ...
            <button onClick={() => setRightTab('ai')}
              className={`px-3 py-1 rounded-t border-b-2 ${rightTab === 'ai' ? 'border-sky-500 text-sky-300' : 'border-transparent text-slate-500 hover:text-slate-300'}`}>
              AI
            </button>
          </div>
